...
let product_price = [500.00,200.00,750.00,2000.00,1600.00,300.00,800.00,5000.00,500.00,600.00,1200.00,1200.00,2000.00,2000.00, 5000.00, 750.00,200.00,800.00,900.00,750.00];
    
for (i = 0; i < products.length; i++) {
    let products_length = products[i].length;

    if (products_length % 2 === 0) {
        product_price[i] *= 2;
    }else {
        product_price[i] /= 2;
    }

    document.write(`The price of ${products[i]} is $${product_price[i]}. <br>`);     
}
