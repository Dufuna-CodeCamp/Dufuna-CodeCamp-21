...
SELECT COUNT(*) FROM registered_passengers LEFT JOIN travel_details ON registered_passengers.PassengerId=travel_details.PassengerId WHERE TripFares>100 AND SiblingsSpousesAboard > 0 AND registered_passengers.age > 35;