...
class ArticlesController
{
    ...
    public function getAllArticles(Request $request, Response $response)
    {
    ...
    public function createSingleArticle(Request $request, Response $response, $args)
    {
    ...
    public function getSingleArticle(Request $request, Response $response, $args)
    {
    ...
    public function updateSingleArticle(Request $request, Response $response, $args)
    {
    ...
    public function getPublishedArticle(Request $request, Response $response, $args)
    {
