...
type INT NOT NULL,
fast_food_category VARCHAR(250) NOT NULL,
veg_fruits_category VARCHAR(250) NOT NULL,
drinks_cocktails_category VARCHAR(250) NOT NULL,
restaurants_category VARCHAR(250) NOT NULL,
PRIMARY KEY(id)
);
