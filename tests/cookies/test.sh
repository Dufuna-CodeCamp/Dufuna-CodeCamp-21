...
echo -n "Enter HTML file name & location (e.g HTML-FORMS/sign-up.html) : "
read html_file
...
env FILE_PATH=$submission_directory/$folder_name/$html_file mocha $PWD/cookies.js --reporter mochawesome --reporter-options reportDir=$customReportDir,reportFilename=$customReportFilename,quiet=true
