...
check_file_content2() {    
    for currentFile in $path_to_php_folder/*
    do
        if grep  "yard"  $currentFile && grep "1.094" $currentFile
        then
            content_exists=1
            break     
        else
...
check_file_content3() {    
    for currentFile in $path_to_php_folder/*
    do
        if grep  "pound"  $currentFile && grep "2.205" $currentFile
        then
            content_exists=1
            break     
        else
...
check_file_content4() {    
    for currentFile in $path_to_php_folder/*
    do
        if grep "fahrenheit"  $currentFile && grep "1.8" $currentFile
        then
            content_exists=1
            break     
        else
...
check_file_content5() {    
    for currentFile in $path_to_php_folder/*
    do
        if grep "32"  $currentFile && grep "=" $currentFile
        then
            content_exists=1
            break     
        else
