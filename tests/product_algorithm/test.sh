...
env FILE_PATH=$submission_directory/$folder_name/$js_file mocha $PWD/product_algorithm.js --reporter mochawesome --reporter-options reportDir=$customReportDir,reportFilename=$customReportFilename,quiet=true
