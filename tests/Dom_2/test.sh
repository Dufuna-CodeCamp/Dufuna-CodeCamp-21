...
env FILE_PATH=$submission_directory/$folder_name/$html_file mocha $PWD/dom.js --reporter mochawesome --reporter-options reportDir=$customReportDir,reportFilename=$customReportFilename,quiet=true
